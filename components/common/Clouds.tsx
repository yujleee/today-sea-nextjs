...
import styles from 'styles/components/Clouds.module.scss';
    ...
    <div className={styles.cloudsWrapper}>
      <div className={styles.clouds}>
        ...
        <svg
          ...
          enableBackground="new 0 0 762 331"
          xmlSpace="preserve"
          className={`${styles.cloud} ${styles.distant} ${styles.smaller}`}
        >
          <path
            d="M715.394,228h-16.595c0.79-5.219,1.201-10.562,1.201-16c0-58.542-47.458-106-106-106
                    c-8.198,0-16.178,0.932-23.841,2.693C548.279,45.434,488.199,0,417.5,0c-84.827,0-154.374,65.401-160.98,148.529
        ...
        <svg
          ...
          enableBackground="new 0 0 762 331"
          xmlSpace="preserve"
          className={`${styles.cloud} ${styles.distant} ${styles.superSlow} ${styles.massive}`}
        >
          <path
            d="M715.394,228h-16.595c0.79-5.219,1.201-10.562,1.201-16c0-58.542-47.458-106-106-106
                    c-8.198,0-16.178,0.932-23.841,2.693C548.279,45.434,488.199,0,417.5,0c-84.827,0-154.374,65.401-160.98,148.529
        ...
        <svg
          ...
          enableBackground="new 0 0 762 331"
          xmlSpace="preserve"
          className={`${styles.cloud} ${styles.slower}`}
        >
          <path
            d="M715.394,228h-16.595c0.79-5.219,1.201-10.562,1.201-16c0-58.542-47.458-106-106-106
                    c-8.198,0-16.178,0.932-23.841,2.693C548.279,45.434,488.199,0,417.5,0c-84.827,0-154.374,65.401-160.98,148.529
